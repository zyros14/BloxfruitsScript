...
local function AddESP(Model)
    if FruitHighlights[Model] then return end
    ...
    FruitHighlights[Model] = Highlight
end

local function RemoveESP(Model)
    if FruitHighlights[Model] then
        FruitHighlights[Model]:Destroy()
        FruitHighlights[Model] = nil
    end
end
...
function Module.Init(Tab)
    ...
    MakeToggle(Tab, "Fruit ESP", function(Value)
        Running = Value
        if Value then
            FruitLoop()
        else
            for Model, _ in pairs(FruitHighlights) do
                RemoveESP(Model)
            end
        end
    end)
